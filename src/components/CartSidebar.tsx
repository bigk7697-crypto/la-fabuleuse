      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 h-full w-full sm:w-96 sm:max-w-md bg-[#141414] z-50 shadow-2xl flex flex-col"
          >
            <div className="p-4 sm:p-6 border-bottom border-white/10 flex items-center justify-between">
              <h2 className="text-xl sm:text-2xl font-bold text-[#d4af37]">Votre Panier</h2>
            ...
            {items.length > 0 && (
              <div className="p-4 sm:p-6 bg-[#1a1a1a] border-t border-white/10 space-y-4">
                ...
                <button
                  onClick={handleOrder}
                  className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white py-3 sm:py-4 rounded-xl flex items-center justify-center gap-3 font-bold transition-all shadow-lg text-sm sm:text-base"
                >
        ...
        {showConfirmModal && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-0 m-auto w-full max-w-sm sm:max-w-md h-fit bg-[#1a1a1a] rounded-2xl sm:rounded-3xl p-6 sm:p-8 z-[70] border border-white/10 shadow-2xl mx-4"
            >
              <div className="text-center">
                <div className="w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center mx-auto mb-6">
                  <MessageCircle size={32} className="text-white" />
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">Confirmer votre commande</h3>
                ...
                <div className="flex gap-4">
                  ...
                  className="flex-1 bg-white/10 hover:bg-white/20 text-white py-2.5 sm:py-3 rounded-xl transition-all text-sm sm:text-base"
                  >
                    Annuler
                  </button>
                  <button
                    onClick={confirmOrder}
                    className="flex-1 bg-[#25D366] hover:bg-[#128C7E] text-white py-2.5 sm:py-3 rounded-xl transition-all font-bold text-sm sm:text-base"
                  >
                    Commander sur WhatsApp
                  </button>
                </div>
